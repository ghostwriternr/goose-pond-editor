/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4b5513b18a4294aa58842e08c073fc9)
// Runtime types generated with workerd@1.20260212.0 2026-02-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SessionTracker";
	}
	interface Env {
		DIFFS: R2Bucket;
		CF_AIG_TOKEN: string;
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
		SessionTracker: DurableObjectNamespace<import("./src/index").SessionTracker>;
	}
}
